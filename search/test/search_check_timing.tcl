...
puts "PASS: check_setup no_input_delay"

puts "--- check_setup -no_output_delay ---"
check_setup -verbose -no_output_delay
puts "PASS: check_setup no_output_delay"
...
puts "PASS: check_setup unconstrained_endpoints"
...
puts "PASS: check_setup generated_clocks"
...
puts "PASS: check_setup combined flags"
...
puts "PASS: gated clock enable settings"
...
puts "PASS: recovery/removal settings"
