...
puts "PASS: clock_skew hold internal_latency"
...
puts "PASS: clock_latency digits 6"
...
puts "PASS: find_clk_min_period clk1"
...
puts "PASS: find_clk_min_period clk2"
...
puts "PASS: inter-clock latency+uncertainty timing"

puts "--- clock skew after latency+uncertainty ---"
report_clock_skew -setup
report_clock_skew -hold
puts "PASS: skew after latency+uncertainty"
...
report_checks -path_delay max
report_clock_skew -setup
puts "PASS: async clock groups skew"
