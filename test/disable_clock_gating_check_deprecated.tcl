# Deprecated set_disable_inferred_clock_gating alias still disables checks.
...
puts "disable cg1"
set_disable_inferred_clock_gating [get_cells cg1]
puts "cg1"
report_checks -to cg1/B -path_delay max -format end
puts "cg2"
report_checks -to cg2/B -path_delay max -format end
...
puts "unset cg1"
unset_disable_inferred_clock_gating [get_cells cg1]
puts "cg1"
report_checks -to cg1/B -path_delay max -format end
puts "cg2"
report_checks -to cg2/B -path_delay max -format end
