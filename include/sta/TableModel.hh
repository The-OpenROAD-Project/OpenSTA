...
class GateTableModel : public GateTimingModel
{
 public:
  ...
  virtual void reportGateDelay(const LibertyCell *cell,
                               ...
                               int digits,
                               string *result) const;
  virtual float driveResistance(const LibertyCell *cell, const Pvt *pvt) const;
...
{
 public:
  TableModel(Table *table, ScaleFactorType scale_factor_type, RiseFall *rf);
  ~TableModel();
  ...
  float findValue(float value1, float value2, float value3) const;
  ...
  void reportValue(const char *result_name,
                   ...
                   int digits,
                   string *result) const;
  void report(const Units *units, Report *report) const;
...
class Table
{
 public:
  ...
  void setIsScaled(bool is_scaled);
  // Table interpolated lookup.
  virtual float findValue(float value1, float value2, float value3) const = 0;
  // Table interpolated lookup with scale factor.
  float findValue(const LibertyLibrary *library,
                  const LibertyCell *cell,
                  const Pvt *pvt,
  ...
  virtual void report(const Units *units, Report *report) const = 0;
...
class Table0 : public Table
{
 public:
  ...
  virtual float findValue(float value1, float value2, float value3) const;
  virtual void reportValue(const char *result_name,
                           const LibertyLibrary *library,
                           const LibertyCell *cell,
                           const Pvt *pvt,
                           ...
                           int digits,
                           string *result) const;
  virtual void report(const Units *units, Report *report) const;
...
{
 public:
  Table1(FloatSeq *values, TableAxis *axis1, bool own_axis1);
  virtual ~Table1();
...
class Table2 : public Table
{
 public:
  ...
  float tableValue(size_t index1, size_t index2) const;
  virtual float findValue(float value1, float value2, float value3) const;
  virtual void reportValue(const char *result_name,
                           const LibertyLibrary *library,
                           const LibertyCell *cell,
...
class Table3 : public Table2
{
 public:
  ...
  float tableValue(size_t index1, size_t index2, size_t index3) const;
  virtual float findValue(float value1, float value2, float value3) const;
  virtual void reportValue(const char *result_name,
                           const LibertyLibrary *library,
                           const LibertyCell *cell,
...
{
 public:
  TableAxis(TableAxisVariable variable, FloatSeq *values);
  ~TableAxis();
